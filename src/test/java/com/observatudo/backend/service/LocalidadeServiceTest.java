 ...
 */
 ...
 public class LocalidadeServiceTest {
     ...
     public void setup() {
         ...
         localidadesLoaderService.loadLocalidades(); // Carregar as localidades antes de cada teste
     }
     ...
     public void testListarEstadosComCidades() throws Exception {
         ...
         assertFalse(saoPauloDTO.getCidades().isEmpty(), "Lista de cidades do estado São Paulo não deve estar vazia.");
     }
